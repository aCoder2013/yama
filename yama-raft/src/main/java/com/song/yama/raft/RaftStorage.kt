...
interface RaftStorage {
     ...
     */
    fun entries(low: Long, high: Long, maxSize: Long): Result<List<RaftProtoBuf.Entry>>
     ...
     */
    fun snapshot(): Result<RaftProtoBuf.Snapshot>

    /**
     * ApplySnapshot overwrites the contents of this Storage object with those of the given sna
     */
    fun applySnapshot(snapshot: RaftProtoBuf.Snapshot): Result<Void>
     ...
     */
    fun createSnapshot(i: Long, cs: RaftProtoBuf.ConfState, data: ByteArray): Result<RaftProtoBuf.Snapshot>
     ...
     * ms.entries[0].Index
     */
    fun append(entries: List<RaftProtoBuf.Entry>): Result<Void>

    /**
     * SetHardState saves the current HardState.
     */
    fun setHardState(hardState: RaftProtoBuf.HardState)
}
