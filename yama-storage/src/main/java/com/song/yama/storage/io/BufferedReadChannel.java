...
public class BufferedReadChannel extends BufferedChannelBase {
    ...
    /**
     * Read as many bytes into dest as dest.capacity() starting at position pos in the FileChannel. This function can
     * read from the buffer or the file channel depending on the implementation..
     *
     * @return The total number of bytes read. -1 if the given position is greater than or equal to the file's current
     * size.
