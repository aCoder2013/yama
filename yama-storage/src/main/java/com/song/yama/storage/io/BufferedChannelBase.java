...
/**
 * A {@code BufferedChannelBase} adds functionality to an existing file channel, the ability to buffer the input and
 * output data. This class is a base class for wrapping the {@link FileChannel}.
 *
